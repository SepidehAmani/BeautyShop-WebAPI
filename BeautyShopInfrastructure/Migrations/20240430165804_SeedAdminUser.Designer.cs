...
namespace BeautyShopInfrastructure.Migrations
{
    ...
    [Migration("20240430165804_SeedAdminUser")]
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.Product.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -2,
                            CreateDate = new DateTime(2024, 4, 30, 21, 28, 3, 906, DateTimeKind.Local).AddTicks(6257),
                            IsDelete = false,
                            Name = "آرایشی",
                            ParentId = 0
                        },
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 4, 30, 21, 28, 3, 906, DateTimeKind.Local).AddTicks(6264),
                            IsDelete = false,
                            Name = "بهداشتی",
                            ParentId = 0
                        });
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 4, 30, 21, 28, 3, 906, DateTimeKind.Local).AddTicks(6061),
                            IsDelete = false,
                            UniqueName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 4, 30, 21, 28, 3, 906, DateTimeKind.Local).AddTicks(6322),
                            IsDelete = false,
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.UserSelectedRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 4, 30, 21, 28, 3, 906, DateTimeKind.Local).AddTicks(6295),
                            IsDelete = false,
                            RoleId = -1,
                            UserId = -1
                        });
