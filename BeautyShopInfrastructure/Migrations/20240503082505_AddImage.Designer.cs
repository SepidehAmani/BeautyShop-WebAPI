...
namespace BeautyShopInfrastructure.Migrations
{
    ...
    [Migration("20240503082505_AddImage")]
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.Product.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -2,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1227),
                            IsDelete = false,
                            Name = "آرایشی"
                        },
                        new
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1233),
                            IsDelete = false,
                            Name = "بهداشتی"
                        },
                        new
                        {
                            Id = -4,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1235),
                            IsDelete = false,
                        ...
                        {
                            Id = -3,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1238),
                            IsDelete = false,
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.Product.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -4,
                            CategoryId = -4,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(2360),
                            Description = "",
                        ...
                        new
                        {
                            Id = -3,
                            CategoryId = -3,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(2371),
                            Description = "",
                            DiscountPercentage = 10,
                            IsDelete = false,
                            Name = "Product3",
                        ...
                        new
                        {
                            Id = -2,
                            CategoryId = -4,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(2374),
                            Description = "",
                            DiscountPercentage = 10,
                            IsDelete = false,
                            Name = "Product2",
                        ...
                        new
                        {
                            Id = -1,
                            CategoryId = -3,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(2377),
                            Description = "",
                            DiscountPercentage = 10,
                            IsDelete = false,
                            Name = "Product1",
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(816),
                            IsDelete = false,
                            UniqueName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1316),
                            IsDelete = false,
            ...
            modelBuilder.Entity("BeautyShopDomain.Entities.User.UserSelectedRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateDate = new DateTime(2024, 5, 3, 12, 55, 4, 777, DateTimeKind.Local).AddTicks(1280),
                            IsDelete = false,
                            RoleId = -1,
                            UserId = -1
                        });
